...
SBATCH_JOB_NAME="3ddl_sk3d.experiments.test_colmap.fuse"
...
sbatch \
    ...
    /gpfs/data/gpfs0/o.voinov/sk3d/sk3d.experiments/COLMAP/scripts/test_colmap/fuse/sing.fuse.sh
